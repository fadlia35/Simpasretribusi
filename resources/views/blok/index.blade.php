              ...
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Data Blok</h4>
                                <div class="basic-form">
                                    {{-- <form data-action="{{ route('blok.store') }}" method="POST" id="modal-tambah-data">
                                        @csrf
                                        <div class="form-row">
                                            <div class="form-group ">
                                                <label>Pasar</label>
                                                <select name="id_pasar" class="form-control" id="">
                                         ...
                                         --}}
                                    <form data-action="{{ route('blok.store') }}" data-id="" data-type="post" method="POST" id="modal-tambah-data">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="nama" type="text" name="nama" class="form-control" placeholder="NamaBlok1...">
