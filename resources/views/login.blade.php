                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                <a class="text-center" href="index.html"> <h4 class="" style="color: #1853fe">SIMPAS - ADMIN</h4></a>
        
                                <form class="mt-5 mb-5 login-input" action="{{ route('login.post') }}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <input name="name" type="text" class="form-control" placeholder="UID Admin">
                                    </div>
                                    <div class="form-group">
                                ...
                                <p class="mt-5 login-form__footer">Login sebagai Pemilik? <a href="{{ route('login.pemilik') }}" class="text-primary">Klik disini</a></p>
